...
public class TodayAttendanceAdapter extends RecyclerView.Adapter<TodayAttendanceAdapter.ViewHolder> {
   ...
   private List<DivTodayAttendence.ResponseDataItem> list;

    public TodayAttendanceAdapter(Context context, List<DivTodayAttendence.ResponseDataItem> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final DivTodayAttendence.ResponseDataItem readAttendance = list.get(position);

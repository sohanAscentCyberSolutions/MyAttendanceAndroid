...
public class DurationAttendanceAdapter extends RecyclerView.Adapter<DurationAttendanceAdapter.ViewHolder> {
   ...
   private List<DurationRecord.ResponseDataItem> list;

    public DurationAttendanceAdapter(Context context, List<DurationRecord.ResponseDataItem> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final DurationRecord.ResponseDataItem readAttendance = list.get(position);

...
public class SingleAttendanceAdapter extends RecyclerView.Adapter<SingleAttendanceAdapter.ViewHolder> {

    private Context context;
   private List<DateCalnderDate.ResponseDataItem> list;
    DateFormat sdf = new SimpleDateFormat("dd-MM-yyyy HH:mm");
    public SingleAttendanceAdapter(Context context, List<DateCalnderDate.ResponseDataItem> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final DateCalnderDate.ResponseDataItem readAttendance = list.get(position);
       ...
       // holder.tv_status.setText(String.valueOf(readAttendance.getAStatus()));
        ...
        if (readAttendance.getAStatus()!=null){
            if (readAttendance.getAStatus().equalsIgnoreCase("A")){
                ...
                holder.img.setBackgroundResource(R.drawable.lk);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
          ...
          // tv_emp_id=itemView.findViewById(R.id.tvpunch_in);
           ...
           img=itemView.findViewById(R.id.tvVg);

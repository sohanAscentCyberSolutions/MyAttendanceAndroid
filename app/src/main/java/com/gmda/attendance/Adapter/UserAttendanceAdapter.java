...
public class UserAttendanceAdapter extends RecyclerView.Adapter<UserAttendanceAdapter.ViewHolder> {
   ...
   private List<ReadAttendanceById.ResponseDataItem> list;


    public UserAttendanceAdapter(Context context, List<ReadAttendanceById.ResponseDataItem> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final ReadAttendanceById.ResponseDataItem readAttendance = list.get(position);
